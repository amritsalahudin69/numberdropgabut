export const LEVEL_1 = Object.freeze({
  ...
  goals: [
    { id: 'goal-1', x: 440, y: 960, value: 5, operator: '-', width: 160, height: 80 },
    { id: 'goal-2', x: 700, y: 960, value: 6, operator: '-', width: 160, height: 80 },
    { id: 'goal-3', x: 960, y: 960, value: 7, operator: '-', width: 160, height: 80 },
    { id: 'goal-4', x: 1220, y: 960, value: 8, operator: '-', width: 160, height: 80 },
    { id: 'goal-5', x: 1480, y: 960, value: 10, operator: '-', width: 160, height: 80 },
  ],
});
